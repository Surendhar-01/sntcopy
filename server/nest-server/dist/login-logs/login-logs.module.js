...
const login_logs_controller_1 = require("./login-logs.controller");
...
exports.LoginLogsModule = LoginLogsModule = __decorate([
    (0, common_1.Module)({
        controllers: [login_logs_controller_1.LoginLogsController],
        providers: [login_logs_service_1.LoginLogsService],
    })
], LoginLogsModule);
//# sourceMappingURL=login-logs.module.js.map